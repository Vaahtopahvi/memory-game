  ...
  return (
    <>
      <div className="min-h-screen flex flex-col items-center justify-center gap-3 sm:gap-5 bg-gradient-to-r from-primary to-secondary p-4">
        <div className="flex flex-col items-center justify-center text-center bg-black/70 p-3 sm:p-5 rounded-xl">
        ...
        <div
          className={`w-full max-w-3xl ${
            loading
              ...
              : "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 sm:gap-4"
          }`}
        >
          {loading ? (
        ...
        <div className="fixed right-5 bottom-5">
          ...
          />
          {help && (
            <div className="absolute right-12 bottom-12 min-w-56 bg-slate-100 p-4 rounded shadow-lg">
              <p className="text-black">
                This is a Pokémon memory game. Click on one of my favorite
                Pokémons to earn points, but don&apos;t click on the same
                Pokémon twice!
              </p>
            </div>
          )}
